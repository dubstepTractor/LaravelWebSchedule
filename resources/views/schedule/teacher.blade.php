...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            @if(isset($teachers))
                <div class="card mb-3">
                    <div class="card-header"><strong>{{ __('Расписание для преподавателя') }}</strong></div>
                                    ...
                                    <li class="list-group-item">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                {{-- Render dropleft button if isset at least 1 of this 2 elements. --}}

                                                @if($subject->getCommentary() !== null or $subject->getClassroom() !== null)
